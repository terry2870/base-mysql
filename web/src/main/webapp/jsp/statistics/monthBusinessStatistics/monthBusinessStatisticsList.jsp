...
<body class="easyui-layout" fit="true">
	<div region="north" title="查询条件" style="height: 70px; border-style: none">
		<jsp:include page="/jsp/statistics/monthBusinessStatistics/monthBusinessStatisticsSearch.jsp" flush="true" />
	</div>
	<div region="center" id="monthBusinessStatisticsListDiv" class="easyui-tabs">
		<div title="列表显示">
			<table id="monthBusinessStatisticsListTable"></table>
		</div>
...
<script>
	...
	$(function() {
		...
		$("#monthBusinessStatisticsListTable").myDatagrid({
			title : "月营业额统计数据列表",
			emptyMsg : "没有数据",
			fit : true,
			fitColumns : true,
			...
			columns : [[{
				...
				formatter : function(value, rowData) {
					return rowData.amount1 + rowData.amount2 + rowData.amount3 + rowData.amount4;
				}
			}]]
		});
	});
